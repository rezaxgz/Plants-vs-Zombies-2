...
final class ZombieVisualCatalog {
    ...
    private static Map<String, Visual> createVisuals() {
        ...
        add(result, "ZOMBOSS_ICEAGE", "ZOMBOSSMECH_ICEAGE", "768/FULL/ZOMBIE/ZOMBIE_ICEAGE_ZOMBOSS/ZOMBIE_ICEAGE_ZOMBOSS.PAM", "idle");
        add(result, "ZOMBOSS_BEACH", "ZOMBOSSMECH_BEACH", "768/FULL/ZOMBIE/ZOMBIE_BEACH_ZOMBOSS/ZOMBIE_BEACH_ZOMBOSS.PAM", "idle");
