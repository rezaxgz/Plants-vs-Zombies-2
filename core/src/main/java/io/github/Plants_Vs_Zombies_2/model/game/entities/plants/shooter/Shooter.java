...
import io.github.Plants_Vs_Zombies_2.model.game.entities.projectile.effect.PoisonEffect;
import io.github.Plants_Vs_Zombies_2.model.game.entities.projectile.effect.ProjectileEffect;
import io.github.Plants_Vs_Zombies_2.model.game.entities.projectile.movement.BouncingProjectileMovement;
...
public class Shooter extends BasePlant {
    ...
    private Projectile createProjectile(int row, ProjectileDirection direction, int damage) {
        ...
        return new Projectile(type.getDisplayName(), startRow, startColumn,
                ...
                type.getTags().contains(io.github.Plants_Vs_Zombies_2.model.game.entities.plants.PlantTag.PEA));
    }
