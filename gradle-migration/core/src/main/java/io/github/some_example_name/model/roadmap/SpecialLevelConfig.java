...
public final class SpecialLevelConfig {
    ...
    private final List<ProtectedPlantSpec> protectedPlants;
    ...
    private SpecialLevelConfig(
        ...
        this.protectedPlants = immutableCopy(protectedPlants);
    ...
    public List<ProtectedPlantSpec> getProtectedPlants() {
