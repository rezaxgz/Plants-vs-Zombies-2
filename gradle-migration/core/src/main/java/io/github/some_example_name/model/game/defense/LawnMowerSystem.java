package io.github.some_example_name.model.game.defense;
...
import io.github.some_example_name.view.game.LawnMowerView;
...
public final class LawnMowerSystem {
    ...
    public LawnMowerResolution resolve(Board board) {
        ...
        for (int row : reachedRows) {
            ...
            List<Zombie> rowKills = killNonBossZombiesInRow(snapshot, row);
