...
import io.github.some_example_name.model.game.minigame.IZombieCard;
import io.github.some_example_name.model.game.minigame.IZombieLevel;
import io.github.some_example_name.model.game.minigame.VaseBreaker;
import io.github.some_example_name.model.game.minigame.VaseBreakerLevel;
import io.github.some_example_name.model.game.minigame.WallnutBowling;
import io.github.some_example_name.model.game.minigame.WallnutBowlingLevel;
import io.github.some_example_name.model.menu.GameMenu;
import io.github.some_example_name.model.quest.Quest;
import io.github.some_example_name.model.quest.QuestType;
...
public final class TravelLogMenuController {
    ...
    private static void appendIZombieCards(
        ...
        for (int index = 0; index < level.getZombieCards().size(); index++) {
    ...
    private static void startMinigame(User user, io.github.some_example_name.model.game.Game game,
