...
import io.github.some_example_name.model.news.News;
import io.github.some_example_name.model.news.NewsPanel;
import io.github.some_example_name.model.quest.AllQuestsProgress;
...
import io.github.some_example_name.model.security.Sha256;
import io.github.some_example_name.model.shop.item.ItemPrice;
import io.github.some_example_name.model.shop.item.ShopItem;
...
public class User {
    ...
    public boolean canAfford(ItemPrice price) {
        ...
        if (price.getType() == io.github.some_example_name.model.enums.CurrencyType.COIN) {
