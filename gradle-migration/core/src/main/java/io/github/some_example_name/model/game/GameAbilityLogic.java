...
import io.github.some_example_name.model.game.entities.zombies.abilities.FishingHookAbility;
import io.github.some_example_name.model.game.entities.zombies.abilities.ImpThrowAbility;
import io.github.some_example_name.model.game.entities.zombies.abilities.KingBuffAbility;
import io.github.some_example_name.model.game.entities.zombies.abilities.LaserBeamAbility;
import io.github.some_example_name.model.game.entities.zombies.abilities.OctopusThrowAbility;
import io.github.some_example_name.model.game.entities.zombies.abilities.SnowballThrowAbility;
import io.github.some_example_name.model.game.entities.zombies.abilities.SunStealAbility;
import io.github.some_example_name.model.game.entities.zombies.abilities.TombSummonAbility;
import io.github.some_example_name.model.game.entities.zombies.abilities.WeaselReleaseAbility;
import io.github.some_example_name.model.game.entities.zombies.abilities.WizardSpellAbility;
import io.github.some_example_name.model.game.entities.zombies.abilities.ZombieAbility;
import io.github.some_example_name.model.game.entities.zombies.abilities.ZombossAbility;
...
abstract class GameAbilityLogic extends GameUpdateLogic {
    ...
    void activateZomboss(Zombie zomboss,
        ...
        for (BasePlant plant : bossAbility.getLastDestroyedPlants()) {
    ...
    void activateWizardSpell(Zombie wizard,
        ...
        BasePlant target = ((WizardSpellAbility) ability).getLastTarget();
        if (target != null) {
    ...
    void activateKingBuff(Zombie king,
        ...
        Zombie target = ((KingBuffAbility) ability).getLastKnightedZombie();
        if (target != null) {
    ...
    void activateOctopusThrow(Zombie octopusZombie,
        ...
        BasePlant target = ((OctopusThrowAbility) ability).getLastTarget();
        if (target != null) {
    ...
    void returnCrystalSkullSunFromDeadZombies(
        ...
        for (Zombie zombie : zombies) {
            ...
            for (ZombieAbility ability : zombie.getAbilities()) {
                ...
                int droppedSun = ((LaserBeamAbility) ability)
    ...
    void restoreWizardSheepFromDeadZombies(
        ...
        for (Zombie zombie : zombies) {
            ...
            for (ZombieAbility ability : zombie.getAbilities()) {
                ...
                int restored = ((WizardSpellAbility) ability)
    ...
    void updatePlantCooldowns(float deltaSeconds) {
        plantCooldowns.replaceAll((name, remaining) -> Math.max(0.0, remaining - deltaSeconds));
