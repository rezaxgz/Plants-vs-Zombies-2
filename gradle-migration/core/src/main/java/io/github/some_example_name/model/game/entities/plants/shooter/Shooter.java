...
import io.github.some_example_name.model.game.entities.projectile.PiercingProjectile;
import io.github.some_example_name.model.game.entities.projectile.Projectile;
import io.github.some_example_name.model.game.entities.projectile.effect.ChillEffect;
import io.github.some_example_name.model.game.entities.projectile.effect.DamageEffect;
import io.github.some_example_name.model.game.entities.projectile.effect.FireEffect;
import io.github.some_example_name.model.game.entities.projectile.effect.PoisonEffect;
import io.github.some_example_name.model.game.entities.projectile.effect.ProjectileEffect;
import io.github.some_example_name.model.game.entities.projectile.movement.BouncingProjectileMovement;
import io.github.some_example_name.model.game.entities.projectile.movement.LinearProjectileMovement;
import io.github.some_example_name.model.game.entities.projectile.movement.ProjectileDirection;
...
public class Shooter extends BasePlant {
    ...
    private Projectile createProjectile(int row, ProjectileDirection direction, int damage) {
        ...
        return new Projectile(type.getDisplayName(), startRow, startColumn,
                ...
                type.getTags().contains(io.github.some_example_name.model.game.entities.plants.PlantTag.PEA));
    }
