...
import io.github.some_example_name.model.game.minigame.VaseBreakResult;
import io.github.some_example_name.model.game.minigame.VaseBreaker;
import io.github.some_example_name.model.game.minigame.VaseSeedPlantingResult;
    ...
    public static CommandResult handleShowVases(Matcher matcher) {
        ...
        List<Vase> vases = game.getVases().stream()
                .sorted(Comparator.comparingInt(
                        ...
                        .thenComparingInt(vase -> vase.getPosition().getColumn()))
                .toList();
