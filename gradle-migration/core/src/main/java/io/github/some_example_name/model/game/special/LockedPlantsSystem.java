...
public final class LockedPlantsSystem {
    ...
    private final Map<PlantFamily, String> familyRepresentatives;
    ...
    private LockedPlantsSystem(
        ...
        this.mode = mode;
        configuredPlantTypes = canonicalizePlantTypes(plantTypes);
        normalizedConfiguredTypes = normalizeTypes(configuredPlantTypes);
        familyRepresentatives = createFamilyRepresentatives();
    }
    ...
    private Map<PlantFamily, String> createFamilyRepresentatives() {
        Map<PlantFamily, String> representatives = new EnumMap<>(PlantFamily.class);
        if (mode != LockedPlantsMode.FAMILY_REPRESENTATIVES) {
    ...
    public boolean isAllowed(BasePlant plant) {
        ...
        PlantFamily family = PlantFamily.findForPlant(plant);
        String representative = familyRepresentatives.get(family);
