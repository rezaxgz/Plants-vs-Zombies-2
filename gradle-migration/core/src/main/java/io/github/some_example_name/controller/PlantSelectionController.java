...
import io.github.some_example_name.model.game.plantSelector.PlantSelection;
import io.github.some_example_name.model.menu.Menu;
import io.github.some_example_name.model.menu.PlantSelectionMenu;
...
public final class PlantSelectionController {
    ...
    private static CommandResult validatePlantForAdd(
        ...
        if (selection.getSelectedPlants().size() >= selection.getSlotCount()) {
